...
public class TargetGameView extends BorderPane {
    ...
    protected TargetGame baseScene = new TargetGame();
    protected Util util;
  
    // the Y position of "bottom" component
    protected double bottomYPosition;
    protected TargetGameController controller;
    ...
    public TargetGameView(Stage primaryStage) {
        ...
        controller = new TargetGameController(primaryStage, baseScene, animationPaneWidth, animationPaneHeight, trails, status);
