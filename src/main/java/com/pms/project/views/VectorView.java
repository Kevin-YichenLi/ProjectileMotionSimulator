...
import com.pms.project.controllers.VectorController;
...
public class VectorView extends BorderPane {
    ...
    protected Vector baseScene = new Vector();
    protected Util util;
  
    // the Y position of "bottom" component
    protected double bottomYPosition;
    protected VectorController controller;
    ...
    public VectorView(Stage primaryStage) {
        ...
        controller = new VectorController(primaryStage, baseScene, animationPaneWidth, animationPaneHeight, trails, status);
    ...
    protected Region createTop() {
        ...
        MenuItem generalMenuItem = new MenuItem("menuItem.generalSetting");
